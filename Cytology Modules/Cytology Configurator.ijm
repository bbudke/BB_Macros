...
var setupBlock01Defaults = newArray(".zvi", 1, 0, "Do nothing");

var setupBlock02Labels = newArray("Label:", "Obs Unit/Submask Channel:");
var setupBlock02Defaults = newArray("Default label", 1);
...
var setupBlock03Defaults = newArray("Unused", 0, 4095, 0, 4095, "RGB Composite", 0, 0, 0);

var setupBlock04Labels = newArray("Box size for enclosing obs unit:");
var setupBlock04Defaults = newArray(-1, "dummy");

var setupBlock05Labels = newArray("Calibration images (image,obs unit;...):", "Background subtraction data:", "Maxima tolerance:", "Lower threshold:", "Minimum focus size:", "Minimum focus avg. intensity:", "Minimum focus intensity:", "Minimum focus upper decile:", "Active channel for focus counting:");
var setupBlock05Defaults = newArray("null", -50, 70, 250, 10, 50, 3000, 500, -1);
...
var setupBlock07Labels = newArray("Display panels as:", "Spacer length between panels:");
var setupBlock07Defaults = newArray("RGB/Monotone", 20);
