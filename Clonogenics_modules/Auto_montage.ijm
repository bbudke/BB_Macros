...
macro "Auto Montage Configuration Action Tool - C037T0b10CT8b09fTdb09g" {
	...
	runMacro(getDirectory("plugins") + 
		"BB_macros" + File.separator() + 
		"Clonogenics_modules" + File.separator() + 
		"Clonogenics_configurator.ijm", "change|5|" + toString(0) + "|" + channel);
	runMacro(getDirectory("plugins") + 
		"BB_macros" + File.separator() + 
		"Clonogenics_modules" + File.separator() + 
		"Clonogenics_configurator.ijm", "change|5|" + toString(1) + "|" + panelsWide);
	runMacro(getDirectory("plugins") + 
		"BB_macros" + File.separator() + 
		"Clonogenics_modules" + File.separator() + 
		"Clonogenics_configurator.ijm", "change|5|" + toString(2) + "|" + panelsHigh);
	runMacro(getDirectory("plugins") + 
		"BB_macros" + File.separator() + 
		"Clonogenics_modules" + File.separator() + 
		"Clonogenics_configurator.ijm", "change|5|" + toString(3) + "|" + randomize);
	runMacro(getDirectory("plugins") + 
		"BB_macros" + File.separator() + 
		"Clonogenics_modules" + File.separator() + 
		"Clonogenics_configurator.ijm", "change|5|" + toString(4) + "|" + maxOverlap);
}
